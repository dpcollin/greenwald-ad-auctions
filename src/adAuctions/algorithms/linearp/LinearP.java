...
public class LinearP {
	...
	public double[] Solve(){
		try {
		    ...
		    this.x  = cplex.numVarArray(this.market.getNumberUsers(), lb, ub);
		    var[0] = this.x;
		    
    	    cplex.addMaximize(cplex.scalProd(this.x, objvals));
    	    //cplex.addMinimize(cplex.scalProd(this.x, objvals));
